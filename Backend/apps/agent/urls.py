...
from .views import process_vtt_to_markdown_escuelait, process_vtt_to_markdown_youtube, generate_clips_endpoint, segment_video
...
urlpatterns = [
    ...
    path('segment-video', segment_video, name='segment_video'),
]