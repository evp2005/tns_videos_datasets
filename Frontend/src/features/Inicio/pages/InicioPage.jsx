...
import { toast } from 'react-hot-toast'; // ✅ Solo toast, NO Toaster duplicado
...
function InicioPage() {
    ...
    return (
        // ❌ NO incluir Toaster aquí - ya está en App.jsx (ConditionalToaster)
                    ...
                    <div className='mt-6 mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-28 2xl:mx-32'>
                        <div className='flex flex-col gap-5'>
                            ...
                            <span className='max-w-lg text-sm sm:text-base'>
                                Sistema Completo para gestionar transcripción, segmentación y doblaje de contenido educativo.
                            </span>
                            <Link to="/ingesta">
                                <button className='rounded-lg mt-3 flex items-center justify-center font-bold text-white bg-[#196DFF] gap-3 w-32 sm:w-40 h-10 text-sm sm:text-base hover:bg-[#1557D6] transition-colors'>
                        ...
                        <section className='grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
                            <Link to="/ingesta">
                                <article className='flex flex-col justify-center pl-4 gap-2 h-40 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-transparent hover:border-gray-100'>
                        ...
                        <div className="border border-[#EEEFEF] bg-white rounded-xl shadow-sm mb-20 overflow-hidden">
                            <table className="text-[#989898] w-full text-sm text-left">
                                ...
                                <tbody>
                                    <tr className="border-t hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-4 font-medium">108-001</td>
                                    ...
                                    <tr className="border-t hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-4 font-medium">108-002</td>
                                    ...
                                    <tr className="border-t hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-4 font-medium">108-003</td>
                                    ...
                                    <tr className="border-t hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-4 font-medium">108-004</td>
                                    ...
                                    <tr className="border-t hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-4 font-medium">108-005</td>
